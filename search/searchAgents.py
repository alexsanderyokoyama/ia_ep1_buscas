...
class LRTAStarCornersAgent(SearchAgent):
    "A SearchAgent for FoodSearchProblem using LRTA* and your cornersHeuristic"
    def __init__(self):
        self.searchFunction = lambda prob: search.learningRealTimeAStar(prob, cornersHeuristic)
        self.searchType = CornersProblem
